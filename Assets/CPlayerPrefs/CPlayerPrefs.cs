...
public static class CPlayerPrefs
{
    ...
    public static void DeleteKey(string key)
    {
        // Get hashed key
        string cKey = hashedKey(key);
        CodeStage.AntiCheat.Storage.ObscuredPrefs.DeleteKey(cKey);
    }
    ...
    {
        SetString(key, val.ToString(System.Globalization.CultureInfo.InvariantCulture.NumberFormat));
    }
    ...
    {
        string value = GetString(key, defaultValue.ToString(System.Globalization.CultureInfo.InvariantCulture.NumberFormat));
        if (value.Contains(","))
            value = value.Replace(",", ".");
        float tmpFloat = float.Parse(value, System.Globalization.CultureInfo.InvariantCulture.NumberFormat);
        return tmpFloat;
